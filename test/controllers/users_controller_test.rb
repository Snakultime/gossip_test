...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @user2 = User.create(last_name: 'boo', first_name: 'boo', email: 'boo@boo.boo', password: 'boo1', password_confirmation: 'boo1' )
  end

  test "valid signup information" do
    user = User.new(last_name: 'foo', first_name: 'foo', email: 'foo@foo.com', password: 'foo12', password_confirmation: 'foo12')
  ...
  test "Create User: first_name information is empty or blank" do
    # is empty/nil
    user = User.new(last_name: 'foo', first_name: '', email: 'foo@foo.foo', password: 'foo12', password_confirmation: 'foo12')
  ...
  test "Create User: last_name information is empty or blank" do
    # is empty/nil
    user = User.new(last_name: '', first_name: 'foo', email: 'foo@foo.foo', password: 'foo12', password_confirmation: 'foo12' )
    is_missing_test(user)
    # is blank
    user = User.new(last_name: '', first_name: 'foo', email: 'foo@foo.foo', password: 'foo12', password_confirmation: 'foo12')
    is_missing_test(user)
  ...
  test "Create User: email information is missing" do
    # is empty/nil
    user = User.new(last_name: 'foo', first_name: 'foo', email: '', password: 'foo12', password_confirmation: 'foo12')
    is_missing_test(user)
    # is blank
    user = User.new(last_name: 'foo', first_name: 'foo', email: '', password: 'foo12', password_confirmation: 'foo12')
    is_missing_test(user)
  ...
  test 'Create User: email is already taken' do
    user = User.create(last_name: 'foo2', first_name: 'foo2', email: 'foo@foo.foo', password: 'foo13', password_confirmation: 'foo13')
    is_missing_test(user)
